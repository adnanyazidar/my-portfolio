export default function ContactSection() {
  return (
    <section id="contact" className="py-[100px] md:py-[120px] px-6 md:px-12 xl:px-20 2xl:px-[120px] bg-zinc-100">
      <div className="w-full max-w-[1920px] mx-auto">
        <div className="max-w-4xl flex flex-col items-center text-center mx-auto">
          ...
          <p className="font-body text-xl md:text-2xl text-on-surface-variant leading-relaxed font-medium mb-12 max-w-[560px] mx-auto">
            I am open to opportunities as a QA Automation Engineer
            or collaborative projects where I can continue learning
