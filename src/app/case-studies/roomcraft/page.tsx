      ...
      <main className="pt-32 pb-24 px-6 md:px-12 xl:px-20 2xl:px-[120px] max-w-[1920px] mx-auto w-full">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">QA Manual</span>
            <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">Frontend Development</span>
            <span className="px-3 py-1 bg-zinc-100 text-zinc-700 text-sm rounded-full">React Three Fiber</span>
            <span className="px-3 py-1 bg-zinc-100 text-zinc-700 text-sm rounded-full">3-person team</span>
          </div>
        ...
        <section className="mx-auto py-20 border-t border-outline-variant/10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
            <aside className="lg:col-span-3 space-y-12">
              <div>
                <h4 className="text-[0.75rem] font-semibold tracking-widest text-on-surface-variant uppercase mb-6">About RoomCraft</h4>
                <p className="text-sm leading-relaxed text-on-surface-variant">
                  RoomCraft is an ambitious web application designed to simplify interior design through an immersive, real-time 3D experience built with React and React Three Fiber.
                </p>
              </div>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">1 QA + FE, 1 Full Stack, 1 BE</p>
                </div>
                <div>
                  <p className="text-[0.75rem] font-semibold tracking-widest text-on-surface-variant uppercase mb-1">Stack</p>
                  <p className="text-sm font-medium">React, Redux, React Three Fiber, Firebase, Excel</p>
                </div>
                <div>
                  <p className="text-[0.75rem] font-semibold tracking-widest text-on-surface-variant uppercase mb-1">Testing Approach</p>
                  <p className="text-sm font-medium">Manual Exploratory, Cross-Platform</p>
                </div>
                <div>
              ...
              <div>
                ...
                <ul className="text-sm leading-relaxed text-on-surface-variant space-y-2">
                  ...
                  <li>• Built responsive UI components with React, Tailwind CSS, and daisyUI</li>
                  ...
                  <li>• Validated across 14+ devices &amp; documented 15+ visual/interaction bugs</li>
                </ul>
              </div>
            </aside>
            <div className="lg:col-span-9">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <div className="p-10 bg-surface-container-low rounded-lg">
                  ...
                  <ul className="space-y-3 text-on-surface-variant text-sm leading-relaxed">
                    <li className="flex gap-2"><span>•</span> Zero automated regression testing in the initial development phase</li>
                    <li className="flex gap-2"><span>•</span> Tight deployment cycles with frequent UI/3D rendering inconsistencies</li>
                    <li className="flex gap-2"><span>•</span> Risk of defect leakage impacting user experience in production</li>
                    <li className="flex gap-2"><span>•</span> No formal test coverage for complex 3D interactions and state management</li>
                  </ul>
                </div>
              ...
              <div className="max-w-2xl mb-20">
                <h2 className="text-[2rem] font-semibold tracking-tight mb-12">RoomCraft&apos;s Story</h2>
                ...
                <div className="bg-surface-container-low border border-outline-variant/15 rounded-xl p-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-on-surface-variant">Simulated real-world user journeys—from furniture selection to 3D room customization—to uncover unexpected visual glitches, interaction bugs, and edge cases in high-complexity 3D scenes.</p>
                    </div>
                    <div className="space-y-4">
                      <div className="w-10 h-10 bg-secondary/10 flex items-center justify-center rounded text-secondary">
                      ...
                      <p className="text-sm text-on-surface-variant">Validated visual consistency and performance across 14+ browser and device combinations, including desktop, tablet, and mobile views, ensuring the 3D environment remained responsive and stable.</p>
                    </div>
                    <div className="space-y-4">
                      <div className="w-10 h-10 bg-secondary/10 flex items-center justify-center rounded text-secondary">
                      ...
                      <p className="text-sm text-on-surface-variant">Established a standardized bug reporting workflow, providing clear reproduction steps, annotated screenshots, and severity ratings to accelerate developer triage and resolution.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-20">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-[2rem] font-semibold tracking-tight">Key Technical Insights</h2>
                  <span className="text-[0.75rem] font-semibold tracking-widest text-on-surface-variant uppercase">Quality Focus</span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="p-8 border border-outline-variant/15 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-sm text-on-surface-variant leading-relaxed">Built reusable UI components with React and Tailwind CSS while simultaneously testing them. This dual perspective allowed me to catch UI inconsistencies early and ensure components were both functional and testable.</p>
                  </div>
                  <div className="p-8 border border-outline-variant/15 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="material-symbols-outlined text-secondary">visibility</span>
                      <h4 className="font-bold">Visual &amp; Interaction Focus</h4>
                    </div>
                    <p className="text-sm text-on-surface-variant leading-relaxed">Developed a keen eye for visual regression—catching misaligned 3D models, texture glitches, and rotation/scaling inconsistencies that impacted user immersion.</p>
                  </div>
                  <div className="p-8 border border-outline-variant/15 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-3 mb-4">
                    ...
                    <p className="text-sm text-on-surface-variant leading-relaxed">Worked closely with developers using an iterative feedback loop, ensuring rapid fixes and maintaining momentum during tight sprint cycles.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white border border-outline-variant/15 rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div>
                        ...
                        <p className="text-sm text-on-surface italic bg-red-50/20 p-3 rounded">3D furniture models fail to render on iOS Safari after switching rooms. Console logs &quot;CONTEXT_LOST_WEBGL&quot;.</p>
                      </div>
                  ...
                  <div className="bg-white border border-outline-variant/15 rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div>
                        <p className="text-[0.65rem] font-bold tracking-widest text-on-surface-variant uppercase mb-2">Observed Behavior</p>
                        <p className="text-sm text-on-surface italic bg-orange-50/20 p-3 rounded">OOM crash on mid-range Android devices when loading high-density room layouts and complex furniture meshes.</p>
                      </div>
                      <div className="flex items-center">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant/20 p-8 rounded-xl">
                  <ul className="space-y-4 text-on-surface-variant text-base leading-relaxed">
                    <li className="flex gap-4 items-start">
                      ...
                      <p>QA Manual &amp; Frontend Developer — managed dual role in a 3-person team (1 BE, 1 FE, and myself as QA+FE) over a 1-month sprint</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Built responsive UI components using React, Tailwind CSS, and daisyUI, ensuring design consistency across all pages</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Implemented global state management with Redux Toolkit for furniture data, favorites, and room customization</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Owned end-to-end manual QA for a complex 3D web application with zero automation coverage</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Designed and executed exploratory test sessions focused on 3D rendering, furniture placement, and real-time room customization</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Developed a comprehensive cross-platform test matrix, ensuring consistent performance across desktop, tablet, and mobile devices</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Implemented a structured bug reporting system, reducing developer triage time and improving fix accuracy</p>
                    </li>
                    <li className="flex gap-4 items-start">
                      <span className="material-symbols-outlined text-secondary mt-1">check_circle</span>
                      <p>Collaborated closely with backend and frontend developers to validate fixes and maintain high-quality release cadence</p>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  <div className="p-8 border border-outline-variant/20 rounded-lg text-center bg-white shadow-sm">
                    <p className="text-sm text-on-surface-variant uppercase tracking-widest mb-2 flex items-center justify-center gap-2"><span className="material-symbols-outlined text-sm">bug_report</span> Visual/Interaction Bugs Caught</p>
                    <p className="text-4xl font-bold text-secondary">15+</p>
                    <p className="text-xs text-on-surface-variant mt-2">Before final prototype</p>
                  </div>
                  <div className="p-8 border border-outline-variant/20 rounded-lg text-center bg-white shadow-sm">
                    <p className="text-sm text-on-surface-variant uppercase tracking-widest mb-2 flex items-center justify-center gap-2"><span className="material-symbols-outlined text-sm">devices</span> Cross-Platform Coverage</p>
                    <p className="text-4xl font-bold text-secondary">14+</p>
                    <p className="text-xs text-on-surface-variant mt-2">Browser/OS combinations</p>
                  </div>
                  <div className="p-8 border border-outline-variant/20 rounded-lg text-center bg-white shadow-sm">
                    <p className="text-sm text-on-surface-variant uppercase tracking-widest mb-2 flex items-center justify-center gap-2"><span className="material-symbols-outlined text-sm">schedule</span> Timeline</p>
                    <p className="text-4xl font-bold text-secondary">1 Month</p>
                    <p className="text-xs text-on-surface-variant mt-2">From concept to delivery</p>
                  </div>
                  <div className="p-8 border border-outline-variant/20 rounded-lg text-center bg-white shadow-sm">
                    <p className="text-sm text-on-surface-variant uppercase tracking-widest mb-2 flex items-center justify-center gap-2"><span className="material-symbols-outlined text-sm">verified</span> User Satisfaction</p>
                    <p className="text-4xl font-bold text-secondary">Zero</p>
                    <p className="text-xs text-on-surface-variant mt-2">Post-launch visual defects reported</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mx-auto py-20 border-t border-outline-variant/10 w-full mb-20">
          <div className="w-full max-w-4xl mx-auto">
            <h2 className="text-[2rem] font-semibold tracking-tight mb-12 text-center">Key Learnings</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-surface-container-low p-8 rounded-xl border border-outline-variant/15">
                ...
                <p className="text-on-surface-variant text-base leading-relaxed">
                  <strong>Exploratory Testing is Essential:</strong> Critical for uncovering nuanced visual and interaction bugs in dynamic 3D environments that scripted tests miss.
                </p>
              </div>
              <div className="bg-surface-container-low p-8 rounded-xl border border-outline-variant/15">
                <span className="material-symbols-outlined text-secondary mb-4 text-3xl">description</span>
                <p className="text-on-surface-variant text-base leading-relaxed">
                  <strong>Clear Bug Reports Build Trust:</strong> Actionable, heavily documented bug reports accelerate development velocity and foster strong dev-QA trust.
                </p>
              </div>
              <div className="bg-surface-container-low p-8 rounded-xl border border-outline-variant/15">
                <span className="material-symbols-outlined text-secondary mb-4 text-3xl">devices</span>
                <p className="text-on-surface-variant text-base leading-relaxed">
                  <strong>Cross-Platform Validation:</strong> Ensures a consistent, reliable user experience and immersion across fragmented hardware and all major devices.
                </p>
              </div>
              <div className="bg-surface-container-low p-8 rounded-xl border border-outline-variant/15">
                <span className="material-symbols-outlined text-secondary mb-4 text-3xl">verified_user</span>
                <p className="text-on-surface-variant text-base leading-relaxed">
                  <strong>Manual QA Delivers Quality:</strong> Plays a critical and irreplaceable role in the final mile of delivering pixel-perfect, immersive applications.
                </p>
              </div>
            </div>
          </div>
